...
exports.EpvInputSchema = exports.DcfInputSchema = exports.z = exports.InputValidationError = void 0;
exports.dcf = dcf;
exports.epv = epv;
exports.buildCspHtml = buildCspHtml;
...
exports.DcfInputSchema = zod_1.z.object({
    fcf0: zod_1.z.number().positive(),
    growth: zod_1.z.number().min(0).lt(1),
    wacc: zod_1.z.number().min(0).lt(1),
    horizon: zod_1.z.number().int().min(1),
    terminalMultiple: zod_1.z.number().positive(),
    shares: zod_1.z.number().positive(),
});
exports.EpvInputSchema = zod_1.z.object({
    ebit: zod_1.z.number().positive(),
    taxRate: zod_1.z.number().min(0).lt(1),
    reinvestmentRate: zod_1.z.number().min(0).lt(1),
    wacc: zod_1.z.number().min(0).lt(1),
    shares: zod_1.z.number().positive(),
});
