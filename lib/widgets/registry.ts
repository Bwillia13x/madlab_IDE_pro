...
const widgetComponents: Record<string, () => Promise<{ default: React.ComponentType<any> }>> = {
  ...
  'line-chart': () =>
    import('@/components/widgets/LineChart').then((m) => ({ default: m.LineChart })),
  'bar-chart': () => import('@/components/widgets/BarChart').then((m) => ({ default: m.BarChart })),
  volume: () =>
    import('@/components/widgets/VolumeWidget').then((m) => ({ default: m.VolumeWidget })),
  ...
  'stress-scenarios': () =>
    import('@/components/widgets/StressScenarios').then((m) => ({ default: m.StressScenarios })),
  'factor-exposures': () =>
    import('@/components/widgets/FactorExposures').then((m) => ({ default: m.FactorExposures })),
  'correlation-matrix': () =>
    import('@/components/widgets/CorrelationMatrix').then((m) => ({
      default: m.CorrelationMatrix,
    })),
  'greeks-surface': () =>
    import('@/components/widgets/GreeksSurface').then((m) => ({ default: m.GreeksSurface })),
  'vol-cone': () => import('@/components/widgets/VolCone').then((m) => ({ default: m.VolCone })),
  'strategy-builder': () =>
    import('@/components/widgets/StrategyBuilder').then((m) => ({ default: m.StrategyBuilder })),
  'pnl-profile': () =>
    import('@/components/widgets/PnLProfile').then((m) => ({ default: m.PnLProfile })),
  'blank-tile': () =>
    import('@/components/widgets/BlankTile').then((m) => ({ default: m.BlankTile })),

  // New enhanced widgets
  'candlestick-chart': () =>
    import('@/components/widgets/CandlestickChart').then((m) => ({ default: m.CandlestickChart })),
  'portfolio-tracker': () =>
    import('@/components/widgets/PortfolioTracker').then((m) => ({ default: m.PortfolioTracker })),
  'technical-indicators': () =>
    import('@/components/widgets/TechnicalIndicators').then((m) => ({
      default: m.TechnicalIndicators,
    })),

  // Interactive and real-time widgets
  'interactive-candlestick': () =>
    import('@/components/widgets/InteractiveCandlestickChart').then((m) => ({
      default: m.InteractiveCandlestickChart,
    })),
  'realtime-portfolio': () =>
    import('@/components/widgets/RealtimePortfolioDashboard').then((m) => ({
      default: m.RealtimePortfolioDashboard,
    })),

  // Advanced portfolio and charting widgets
  'portfolio-allocation': () =>
    import('@/components/widgets/PortfolioAllocationCharts').then((m) => ({
      default: m.PortfolioAllocationCharts,
    })),
  'predictive-insights': () =>
    import('@/components/widgets/PredictiveInsights').then((m) => ({
      default: m.PredictiveInsights,
    })),
  watchlist: () =>
    import('@/components/widgets/WatchlistWidget').then((m) => ({ default: m.WatchlistWidget })),
  'options-dashboard': () =>
    import('@/components/widgets/OptionsDashboardWidget').then((m) => ({
      default: m.OptionsDashboardWidget,
    })),
  'market-overview': () =>
    import('@/components/widgets/MarketOverviewWidget').then((m) => ({
      default: m.MarketOverviewWidget,
    })),
  'portfolio-performance': () =>
    import('@/components/widgets/PortfolioPerformanceWidget').then((m) => ({
      default: m.PortfolioPerformanceWidget,
    })),
  'news-events-feed': () =>
    import('@/components/widgets/NewsEventsFeedWidget').then((m) => ({
      default: m.NewsEventsFeedWidget,
    })),
  'backtesting-framework': () =>
    import('@/components/widgets/BacktestingFrameworkWidget').then((m) => ({
      default: m.BacktestingFrameworkWidget,
    })),
  'financials-summary': () =>
    import('@/components/widgets/FinancialsSummary').then((m) => ({
      default: m.FinancialsSummary,
    })),
  'peer-comparison': () =>
    import('@/components/widgets/PeerComparison').then((m) => ({ default: m.PeerComparison })),
  'quarterly-financials': () =>
    import('@/components/widgets/QuarterlyFinancials').then((m) => ({
      default: m.QuarterlyFinancials,
    })),
  'income-statement-breakdown': () =>
    import('@/components/widgets/IncomeStatementBreakdown').then((m) => ({
      default: m.IncomeStatementBreakdown,
    })),
  'kpi-mini-grid': () =>
    import('@/components/widgets/KpiMiniGrid').then((m) => ({ default: m.KpiMiniGrid })),
  screener: () =>
    import('@/components/widgets/ScreenerWidget').then((m) => ({ default: m.ScreenerWidget })),
  'paper-trading-console': () =>
    import('@/components/widgets/PaperTradingConsole').then((m) => ({
      default: m.PaperTradingConsole,
    })),
  'options-chain': () =>
    import('@/components/widgets/OptionsChainWidget').then((m) => ({
      default: m.OptionsChainWidget,
    })),
  'advanced-chart': () =>
    import('@/components/widgets/AdvancedChart').then((m) => ({ default: m.AdvancedChart })),
  'market-ticker-hft': () =>
    import('@/components/widgets/MarketTickerHFT').then((m) => ({ default: m.MarketTickerHFT })),
  microstructure: () =>
    import('@/components/widgets/MicrostructureWidget').then((m) => ({
      default: m.MicrostructureWidget,
    })),
};
...
export async function getWidgetComponent(
  type: string
): Promise<React.ComponentType<{ widget: unknown; sheetId: string }> | null> {
