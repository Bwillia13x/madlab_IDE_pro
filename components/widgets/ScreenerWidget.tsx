...
export function ScreenerWidget({ widget }: Readonly<ScreenerWidgetProps>) {
  ...
  const filteredStocks = useMemo(() => {
    ...
    return enriched.filter((stock) => {
      ...
      if (filters.minMarketCap && stock.marketCap < parseFloat(filters.minMarketCap) * 1e9)
        return false;
    ...
    <Card className="h-full">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          ...
          <div className="space-y-1">
            <Label htmlFor="minMarketCap" className="text-xs">
              Min Market Cap (B)
            </Label>
            <Input
              id="minMarketCap"
          ...
          <div className="space-y-1">
            <Label htmlFor="maxPE" className="text-xs">
              Max P/E
            </Label>
            <Input
              id="maxPE"
